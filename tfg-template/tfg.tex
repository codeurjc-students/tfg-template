...
\newcommand{\nombreautor}{Nombre Apellsido1 Apellido2}
\newcommand{\nombretutor}{NombreTutor Apellido1 Apellido2}
\newcommand{\titulotrabajo}{Título del Trabajo de Fin de Grado}
\newcommand{\grado}{Grado en Ingeniería XXX}
\newcommand{\curso}{Curso 202X-202Y}
...
% Cuarto anexo
\chapter{Documentación LaTeX}
\label{anexo:latex}
\tutor{Este anexo DEBE borrarse al terminar la memoria, solo contiene ejemplos de uso de LaTeX}
