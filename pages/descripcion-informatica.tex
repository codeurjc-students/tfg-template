...
\begin{itemize}
    ...
    \item Extensión 2/3 páginas (salvo que haya alguna tecnología de partes optativas que necesite describirse en detalle). 
\end{itemize}
...
\subsection{API REST} 
Se describirá en alto nivel la API REST como un listado de los recursos y sus operaciones (por ejemplo como el listado de operaciones tal y como aparecen en la documentación de OpenAPI). 
